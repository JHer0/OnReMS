  ...
  <body>
        ...
        <!-- Page Content -->
        <div class="row text-right me-5 pe-5">
        <div class="row text-white text-center">
            ...
            <div class="col-3 align-bottom"> <br><br>ACTIVITY COLOR SCHEME</div>
            <div class="col-1"></div>
            <div class="col-1">
                <label class="color-text">Urgent <br>Meeting</label><br>
                    <input type="text" class="form-control d-inline" style="background:#FF0000; width:10px" required readonly>
            </div>
            <div class="col-1">
                <label class="color-text">Personal Schedule</label><br>
                    <input type="text" class="form-control d-inline" style="background:#008000; width:10px" required readonly>
            </div>
            <div class="col-1">
                <label class="color-text">Executives Schedule</label><br>
                    <input type="text" class="form-control d-inline" style="background:#FF8C00; width:10px" required readonly>
            </div>
            <div class="col-1">
                <label class="color-text"><br>ETC:</label><br>
                    <input type="text" class="form-control d-inline" style="background:#0071c5; width:10px" required readonly>
            </div>
            </div>
                   
        
        <div class="row">
            <section class="content ms-5" >
            <div class="col-md-12">
                <div class="box box-success w-100 ">
                   
                    <div class="box-body ">
                        <div class="row">
                            <div class="col-md-12" style="width: 800">
