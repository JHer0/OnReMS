<html lang="en"><head>
      ...
      <title>Burial Application Form</title>
  ...
  <body><div class="container-fluid bg-dark">
      <div class="row">
          <div class="col text-center pt-3 py-3">
            <h2 class="text-light">Online Records Management System</h2>
          </div>
      </div>
  </div>
  ...
  <div class="container-fluid px-4 border-bottom-1">
    <div class="row pt-2 py-2 text-center">
        ...
        <div class="col-2 p-2 border-start">
                <a href="transferal.php" class="d-inline p-2 text-white fw-bold">
                    Transferal Form
                </a>
        </div>
        
        <div class="col-2 p-2 shadow bg-warning rounded ">
            <a href="bural.php" class="p-2 text-center text-dark fw-bold">
                Burial Form
            </a>
        </div>
        <div class="col-2 p-2 border-end">
            <a href="renewal.php" class="p-2 text-center text-white fw-bold">
                Renewal Form
            </a>
        </div>
...
<div class="row" style="z-index: 0">
                <?php
                  ...
                  if(strpos($fullUrl, "Add=Success!") == true){
                    ...
                    <?php
                   }else if(strpos($fullUrl, "error=checkDataStmtfailed") == true ||
    ...
    <div class="shadow bg-body rounded mt-3 mb-3">
        <div class="row">
            <div class="col mt-4 px-5">
                <h5 class="text-center fw-bold fs-4">Burial Application Form
            </h5>
            </div>
        </div>
        ...
        </div>      <!-- End of Deceased Full Name -->


        <div class="row">

                <!-- Deceased Address -->
                <div class="col-sm mt-md-3 mx-5 mb-2">
                <label class="fw-bold fs-4">Address:</label> 
                      <input type="text" placeholder="Address " class="form-control w-100 shadow rounded border-dark fw-bold" name="dec_address" required=""> 
                </div>
        </div>    <!-- End of Deceased Address -->
                ...
                <div class="col-sm mt-2 mx-5">
                    <select id="sub" class="form-select form-select-sm shadow rounded border-dark fw-bold" name="church_name" aria-label=".form-select-lg" required="">
                        ...
                        <?php
                            $obj->account();
                        ?>
                        <option value = NULL>--Church Not in the list--</option>
                    </select>
                </div>
        </div>

        <div class="row text-dark px-5 mt-2">

                <!-- Birth Day -->
                <div class="col-6 mt-md-1 mt-3"> 
                    <label class="fw-bold fs-4">Date of Birth:</label> 
                        <input type="date" name="born-on" class="form-control w-100 shadow rounded fw-bold border-dark"  required=""> 
                </div>

                <!-- End of Lifespan -->
                <div class="col-6 mt-md-1 mt-3"> 
                  <label class="fw-bold fs-4">Date of Death:</label> 
                    <input type="date" name="died-on" class="form-control w-100 shadow rounded fw-bold border-dark" required=""> 
                </div>
                       
        </div>

        <div class="row text-dark px-5 mt-1">

                <!-- Funeral Interment Date -->
                <div class="col-6 mt-md-1 mt-3"> 
                    <label class="fw-bold fs-4">Funeral Interment Date:</label> 
                        <input type="datetime-local" class="form-control w-100 shadow rounded fw-bold border-dark" name="t_Internment" required="">
                </div>

                 <!-- Funeral Interment Date -->
                 <div class="col-6 mt-md-1 mt-3"> 
                    <label class="fw-bold fs-4">Burial Place:</label> 
                        <!-- <input type="datetime-local" class="form-control w-100 shadow rounded fw-bold border-dark" name="t_Internment" required=""> -->
                        <select id="sub" class="form-select form-select-sm shadow rounded border-dark fw-bold" name="burial_place" aria-label=".form-select-lg">
                        <option value = "Tomb">Select Burial Place</option>
                          <option value = "Tomb">Tomb</option>
                          <option value = "Hossuary">Ossuary</option>
                      </select>
                </div>
        </div>
        ...
        <div class="row mx-5 pt-3">
            <!-- Submit Button -->
            <input type="submit" value="Submit" class="btn btn-primary col-md px-4 mt-3 my-3 fw-bold " name="addBurial"> </input>
        </div>
  </div>
</form>
    <?php
