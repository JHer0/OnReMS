<html lang="en"><head>
      ...
      <title>Transferal Application Form</title>
      <?php
  ...
  <div class="container-fluid px-4 border-bottom-1">
    ...
    <div class="col-1 p-2 border-start">
        ...
        <div class="col-2 p-2 rounded-start shadow bg-warning rounded">
                <a href="transferal.php" class="d-inline p-2 text-dark fw-bold">
                    Transferal Form
                </a>
        </div>
        
        <div class="col-2 p-2 border-end">
            <a href="burial.php" class="p-2 text-center text-white fw-bold">
                Burial Form
            </a>
        </div>
        <div class="col-2 p-2 border-end">
    ...
    <div class="shadow bg-body rounded mt-3 mb-3">
        <div class="row">
            <div class="col mt-4 px-5">
                <h5 class="text-center fw-bold fs-4">Transferal Application Form
            </h5>   
            </div>
        </div>
        ...
        <div class="row text-dark px-5 mt-2">
                ...
                <div class="col-6 mt-md-1 mt-3">
                <label class="fw-bold fs-4">Church Name:</label> 
            ...
            <!-- Submit Button -->
            <input type="submit" value="Submit" class="btn btn-primary col-md px-4 mt-3 my-3 fw-bold " name="addTransferal"> </input>
        </div>
    </form>
</div>
