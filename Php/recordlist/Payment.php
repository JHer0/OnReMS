        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
                    <h1 id = "tabID" style = "" class="text-dark">Payment Records List</h1>
            ...
            <div class="card-body">
                            ...
                            <table class="table table-striped table-md">
                                <thead>
                                    <tr class="text-dark">
                                        ...
                                        <th scope="col">Terment Date</th>
                                        <th scope="col">Terment Time</th>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        if($_SESSION['user'] != $_SESSION['admin'] && $_SESSION['user'] != $_SESSION['chairsec'] && $_SESSION['user'] != $_SESSION['pic']) {
                                            ...
                                            $obj -> viewGenBurial($_SESSION['user'], 1);
                                        }
                ...
                <div class="card mb-2 border border-dark alert alert-info"><!-- TRANSFERAL FORMS -->
                    <div class="card-header">
                    <strong>TRANSFERAL FORMS</strong>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-md">
                                ...
                                <tbody>
                                    <?php
                                        $obj = new View();
                                        if($_SESSION['user'] != $_SESSION['admin'] && $_SESSION['user'] != $_SESSION['chairsec'] && $_SESSION['user'] != $_SESSION['pic']) {
                                            $obj -> viewChurchBurial($_SESSION['user'], 2);
                                        }
                                        else{
                                            $obj -> viewGenBurial($_SESSION['user'], 2);
                                        }
                ...
                <div class="card mb-2 border border-dark alert alert-primary"><!-- RENEWAL FORMS -->
                    <div class="card-header">
                    <strong>RENEWAL FORMS</strong>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-md">
                            <thead>
                                ...
                                <tbody>
                                    <?php
                                        $obj = new View();
                                        if($_SESSION['user'] != $_SESSION['admin'] && $_SESSION['user'] != $_SESSION['chairsec'] && $_SESSION['user'] != $_SESSION['pic']) {
                                            $obj -> viewChurchBurial($_SESSION['user'], 3);
                                        }
                                        else{
                                            $obj -> viewGenBurial($_SESSION['user'], 3);
                                        }
