    ...
    <html>
        ...
        <body>
                ...
                <table  width="100%">
                    ...
                    <tr>
                        <td style = "width:40%" colspan=2><b>Total Number of Church:</b></td>
                        <td style = "width:20%" ><b></b></td>
                        <td style = "width:20%" ><?php $obj->CountChurch();?></td>
                        <td style = "width:20%" ><b></b></td>
                        <!-- <td colspan=2></td> -->
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan=5><b>List of ALICF Church per church as of:
                            <?php echo "$mydate[month] $mydate[mday], $mydate[year] "; ?></b>
                        </td>
                    
                    <tr>
                        <td><?php $obj->viewChurch();?></td>
